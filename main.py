...
parser.add_argument('--seq_len', default=40, type=int, help='seq_len')
...
parser.add_argument('--label_weight', default=1., type=float, help='label_weight')
parser.add_argument('--kl_x_weight', default=1., type=float, help='kl_x_weight')
parser.add_argument('--kl_y_weight', default=1., type=float, help='kl_y_weight')
parser.add_argument('--koopman_weight', default=1., type=float, help='koopman_weight')
